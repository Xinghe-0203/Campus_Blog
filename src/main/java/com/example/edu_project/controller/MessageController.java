...
public class MessageController {
     ...
     * 获取与某个用户的会话消息（私聊窗口）
     */
    @Operation(summary = "获取与某个用户的会话消息")
    @GetMapping("/conversation/{otherUserId}")
    public Result<Page<MessageVO>> getConversationMessages(
        ...
        Page<MessageVO> messages = messageService.getConversationMessages(userId, otherUserId, page, size);
